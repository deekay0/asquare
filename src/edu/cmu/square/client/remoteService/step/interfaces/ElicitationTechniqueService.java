...
@RemoteServiceRelativePath("elicitationTechniques")
public interface ElicitationTechniqueService extends RemoteService {
	/**
	 ...
	 * (for example user already removed)
	 */
	void setRateValue(int projectID, int techniqueID, int evaluationID, int value) throws SquareException;
	 ...
	 */
	GwtTechnique addTechnique(GwtProject gwtProject, GwtTechnique gwtElicitTechnique) throws SquareException;
	 ...
	 * @throws SquareException
	 */
	GwtEvaluation addEvaluation(GwtProject gwtProject, GwtEvaluation gwtElicitEvaluation) throws SquareException;
