...

{
	...
	final ReviewOfRequirementsByAcquisitionDetailPaneMessages messages = (ReviewOfRequirementsByAcquisitionDetailPaneMessages) GWT.create(ReviewOfRequirementsByAcquisitionDetailPaneMessages.class);
