...
public class ChooseStepPilot extends Pilot
{
	public static class PageId
	{
		public static final String home = "choose-step";
	...
	public Widget navigateTo(String pageId, State currentStateInformation)
	{
		...
		{
			return new ChooseStepPane(currentStateInformation);
		} 
		else if (pageId.equals(PageId.member))
		{
			return new ViewMembersPane(currentStateInformation);
		}
	...
	{
		return HistoryManager.ViewId.chooseStep + "/" + pageId;
	}
