...
public class AgreeOnDefinitionsBusinessImpl extends BaseBusinessImpl implements AgreeOnDefinitionsBusiness
{
	...
	@AllowedRoles(roles = {Roles.Administrator, Roles.Lead_Requirements_Engineer, Roles.Contractor, Roles.Acquisition_Organization_Engineer, Roles.Security_Specialist})
