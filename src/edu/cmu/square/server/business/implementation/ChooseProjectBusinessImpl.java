...
public class ChooseProjectBusinessImpl extends BaseBusinessImpl implements ChooseProjectBusiness
{
	...
	public List<GwtProject>[] getProjectsForUser(Integer userId) throws SquareException
	{
		...
		List<Project> projectsInProgress = projectDao.getIncompleteProjectsForUser(userId);
		...
		List<Project> projectsCompleted = projectDao.getCompletedProjectsForUser(userId);
